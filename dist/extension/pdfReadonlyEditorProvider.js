...
exports.PdfReadonlyEditorProvider = void 0;
const path = __importStar(require("node:path"));
const vscode = __importStar(require("vscode"));
const constants_1 = require("./constants");
const pdfDocument_1 = require("./pdfDocument");
const html_1 = require("./webview/html");
const messages_1 = require("./webview/messages");
const security_1 = require("./webview/security");
class PdfReadonlyEditorProvider {
    ...
    openCustomDocument(uri) {
        return new pdfDocument_1.PdfDocument(uri);
    }
    async resolveCustomEditor(document, panel) {
        ...
        disposables.push(webview.onDidReceiveMessage((message) => {
            if (!(0, messages_1.isWebviewToExtensionMessage)(message)) {
                return;
            }
        ...
        webview.html = (0, html_1.buildWebviewHtml)(webview, {
...
exports.PdfReadonlyEditorProvider = PdfReadonlyEditorProvider;
//# sourceMappingURL=pdfReadonlyEditorProvider.js.map