...
function buildWebviewHtml(webview, uris, nonce) {
    ...
    return [
        ...
        '<button id="selectFreestyle" class="icon-button" type="button" title="Freestyle selection" aria-label="Freestyle selection" aria-pressed="true"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 17c2.5 2.2 5.2 2.8 8.1 1.8 4.4-1.6 3.1-6.2 6.9-6.8 1.1-.2 1.9.1 2.5.8"/><path d="M5 15.5 4 17l1.5.9"/></svg></button>',
        '<button id="selectRectangle" class="icon-button" type="button" title="Rectangle selection" aria-label="Rectangle selection" aria-pressed="false"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="5" y="6" width="14" height="12" rx="1.5"/></svg></button>',
        "</div>",
        '<span class="separator" aria-hidden="true"></span>',
